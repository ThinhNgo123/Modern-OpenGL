...
def create_light_vao(vbo):
    ...
    glBindVertexArray(vao)
    glBindBuffer(GL_ARRAY_BUFFER, vbo)
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * np.float32().itemsize, ctypes.c_void_p(0))
    glEnableVertexAttribArray(0)
    return vao
...
light_program = create_shader("./shaders/triangle.vert", "./shaders/light.frag")
