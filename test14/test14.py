...
while True:
    ...
    glUniform3f(ambient_location, 0,0,0)
    glUniform3f(diffuse_location, 0.5,0,0)
    glUniform3f(specular_location, 0.7,0.6,0.6)
    ...
    glUniform3f(ambient_light_location, 1, 1, 1)
    glUniform3f(diffuse_light_location, 1, 1, 1)
    glUniform3f(specular_light_location, 1, 1, 1)
