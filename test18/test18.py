...
direction_light_location = glGetUniformLocation(program, "light.direction")
cutoff_light_location = glGetUniformLocation(program, "light.cutOff")
outer_cutoff_light_location = glGetUniformLocation(program, "light.outerCutOff")
...
constant_light_location = glGetUniformLocation(program, "light.constant")
linear_light_location = glGetUniformLocation(program, "light.linear")
quadratic_light_location = glGetUniformLocation(program, "light.quadratic")
...
while True:
    ...
    glUniform3f(position_light_location, *eye)
    glUniform3f(direction_light_location, *forward)
    # print("forward", forward)
    glUniform1f(cutoff_light_location, math.cos(rad(cutoff)))
    glUniform1f(outer_cutoff_light_location, math.cos(rad(outer_cutoff)))
    glUniform3f(ambient_light_location, 0.1, 0.1, 0.1)
    glUniform3f(diffuse_light_location, 0.8, 0.8, 0.8)
    ...
    glUniform1f(constant_light_location, 1)
    glUniform1f(linear_light_location, 0.022)
    glUniform1f(quadratic_light_location, 0.0019)
