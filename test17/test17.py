...
while True:
    ...
    glUniform3f(ambient_light_location, 0.5, 0.5, 0.5)
    glUniform3f(diffuse_light_location, 0.9, 0.9, 0.9)
    glUniform3f(specular_light_location, 1, 1, 1)
    glUniform1f(constant_light_location, 1)
    glUniform1f(linear_light_location, 0.09)
    glUniform1f(quadratic_light_location, 0.032)
