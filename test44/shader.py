...
class Shader:
    ...
    def __init__(self, vertex_shader_path, fragment_shader_path, geometry_shader_path=None) -> None:
        ...
        if geometry_shader_path:
            geometry_shader_source = self.read_file(geometry_shader_path)
        ...
        geometry_id = self.compile_shader(Shader.GEOMETRY_SHADER, geometry_shader_source) if geometry_shader_path else None

        self.program_id = self.compile_program(vertex_id, fragment_id, geometry_id)
    ...
    def compile_program(self, vertex_shader_id, fragment_shader_id, geometry_shader_id):
        try:
    ...
    def setFloat2(self, name: str, value1: float, value2: float):
        glUniform2f(self.get_location_shader(name), value1, value2)
